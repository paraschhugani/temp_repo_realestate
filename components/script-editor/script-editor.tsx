...
export const ScriptEditor = forwardRef<{ handleSave: () => void}, ScriptEditorProps>(
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`flex justify-between p-6 border-t md:flex-row flex-col ${!dashboard ? "fixed bottom-0 left-0 w-full px-56 bg-white shadow-[0_-4px_10px_rgba(0,0,0,0.1)]" : ""}`}>
